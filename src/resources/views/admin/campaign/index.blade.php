				...
				<form action="{{route('admin.campaign.search')}}" method="post">
					...
					<div class="filter-form">
						...
						<div class="filter-action">
							<button class="i-btn info--btn btn--md" type="submit"><i class="fas fa-search"></i> {{ translate('Search')}}</button>
							@php
							...
							<a href="{{route('admin.campaign.create',strtolower($channel))}}" class="i-btn primary--btn btn--md">
