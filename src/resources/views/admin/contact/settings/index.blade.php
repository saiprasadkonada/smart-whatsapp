...
<section>
    <div class="card mb-4">
        ...
        <div class="card-filter">
            <form action="{{route('admin.contact.settings.attribute.search')}}" method="GET">
                <div class="filter-form">
                    ...
                    <div class="filter-action">
                        ...
                        <a class="i-btn danger--btn btn--md text-white" href="{{ route('admin.contact.settings.index') }}">
...
<script>
    (function($){
        ...
        $('.attribute_status').on('change', function() {
            ...
            $.ajax({
                method: 'get',
                url: "{{ route('admin.contact.settings.status.update') }}",
