						...
						<div class="row">
							...
							<div class="col-sm-12 my-3">
								<div class="switch-container bg---light py-3">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" value="{{ $plan->type == App\Models\PricingPlan::ADMIN ? "true" : "false" }}" name="allow_admin_creds" type="checkbox" id="allow_admin_creds" {{ $plan->type == App\Models\PricingPlan::ADMIN ? "checked" : "" }}>
                                        <span class="slider"></span>
                                    </label>
                                </div>
							</div>
										...
										<div class="form-wrapper border--dark">
											...
											<div class="row">
												<div class="col-lg-12 mb-3 admin-sms-credit">
													...
													<div class="input-group">
														<input type="text" class="form-control" id="sms_credit_admin" name="sms_credit_admin" placeholder="{{ translate('Enter SMS Credit')}}" aria-label="Recipient's username" value="{{ $plan->sms->credits }}" aria-describedby="basic-addon2" >
										...
										<div class="form-wrapper border--dark">
											...
											<div class="row">
												<div class="col mb-3 admin-email-credit">
													...
													<div class="input-group">
														<input value="{{ $plan->email->credits }}" type="text" class="form-control" id="email_credit_admin" name="email_credit_admin" placeholder="{{ translate('Enter Email Credit')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" >
														<span class="input-group-text" id="basic-addon2">{{ translate('Credit')}}</span>
													</div>
												</div>
											</div>
										...
										<div class="form-wrapper border--dark">
											...
											<div class="row">
												<div class="col-lg-6 mb-3 admin-whatsapp-credit">
													...
													<div class="input-group">
														<input value="{{ $plan->whatsapp->credits }}" type="text" class="form-control" id="whatsapp_credit_admin" name="whatsapp_credit_admin" placeholder="{{ translate('Enter Whatsapp Credit')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" >
														<span class="input-group-text" id="basic-addon2">{{ translate('Credit')}}</span>
													</div>
												</div>
										...
										<div class="form-wrapper border--dark">
											...
											<div class="row">
												<div class="col-lg-12 mb-3 user-sms-credit {{ $plan->sms->is_allowed == false ? "d-none" : "" }}">
													...
													<div class="input-group">
														<input value="{{ $plan->sms->credits }}" type="text" class="form-control" id="sms_credit_user" name="sms_credit_user" placeholder="{{ translate('Enter SMS Credit')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" >
														<span class="input-group-text" id="basic-addon2">{{ translate('Credit')}}</span>
													</div>
												</div>
											</div>
												...
												<div class="form-wrapper border--dark">
													...
													<div class="row">
														<div class="col-lg-12 mb-3 user-email-credit {{ $plan->email->is_allowed == false ? "d-none" : "" }}">
															...
															<div class="input-group">
																<input value="{{ $plan->email->credits }}" type="text" class="form-control" id="email_credit_user" name="email_credit_user" placeholder="{{ translate('Enter Email Credit')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" >
																<span class="input-group-text" id="basic-addon2">{{ translate('Credit')}}</span>
															</div>
														</div>
													</div>
												...
												<div class="form-wrapper border--dark">
													...
													<div class="row">
														...
														<div class="col-lg-12 mb-3 user-whatsapp-credit {{ $plan->whatsapp->is_allowed == false ? "d-none" : "" }}">
															...
															<div class="input-group">
																<input value="{{ $plan->whatsapp->credits ?? 0}}" type="text" class="form-control" id="whatsapp_credit_user" name="whatsapp_credit_user" placeholder="{{ translate('Enter Whatsapp Credit')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" >
																<span class="input-group-text" id="basic-addon2">{{ translate('Credit')}}</span>
															</div>
														</div>
													</div>
