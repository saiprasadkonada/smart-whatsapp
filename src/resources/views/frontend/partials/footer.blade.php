                ...
                <div class="col-xl-7 col-lg-8">
                    <div class="footer-item">
                        <div class="footer-info">
                            ...
                            <p>{{getArrayValue(@$footer_content->section_value, 'text')}}</p>
                        </div>
            ...
            <div class="d-flex align-items-center flex-column-reverse flex-md-row justify-content-between text-center gap-4">
                ...
                <ul class="footer-menus">
                    @foreach($pages as $page)
                        <li>
                            <a target="_blank" href="{{route('page',[Str::slug(getArrayValue(@$page->section_value, 'title')),$page->id])}}" class="footer-menu">{{getArrayValue(@$page->section_value, 'title')}}</a>
                        </li>
                    @endforeach
                </ul>
