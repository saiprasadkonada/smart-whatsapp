            ...
            <form id="contact_store" action="{{route('user.contact.store')}}" method="POST">
                ...
                <div class="form-wrapper">
                    ...
                    <div class="form-item mb-4">
                        <label class="form-label" for="group_id">{{ translate('Select a Group')}} <a href="{{ route("user.contact.group.index") }}" target="_blank"><i style="font-size:15px" class="text--primary las la-external-link-alt"></i></a></label>
                            ...
                            <div class="tab-pane fade show active" id="single-tab-pane" role="tabpanel" aria-labelledby="single-tab" tabindex="0">
                                ...
                                @if(count($filteredAttributes) != 0)
                                    <div class="form-wrapper my-3 border--dark">
                                        <div class="row">
                                            <div class="form-wrapper-title"> {{ translate("Custom Attribute Data")}} <a href="{{ route("user.contact.settings.index") }}" target="_blank"><i style="font-size:15px" class="text--primary las la-external-link-alt"></i></a></div>
                                        ...
                                        <div class="d-flex gap-3 flex-column ">
                                            <div>
                                                <div class="form-text mb-3">
                                                    ...
                                                    <a href="{{ route("user.contact.demo.file", "csv" ) }}" class="badge badge--primary"><i class="fa fa-download" aria-hidden="true"></i>{{translate('csv')}}</a>
                                                    {{-- <a href="{{ route("user.contact.demo.file", "xlsx" ) }}" class="badge badge--primary"><i class="fa fa-download" aria-hidden="true"></i> {{ translate('xlsx')}}</a> --}}
                                                </div>
