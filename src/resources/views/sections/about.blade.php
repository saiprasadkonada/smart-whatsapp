    ...
    <div class="container">
        <div class="section-header">
            <div class="section-header-left">
                <span class="sub-title">{{getArrayValue(@$about_content->section_value, 'sub_heading')}}</span>
                <h3 class="section-title">{{getArrayValue(@$about_content->section_value, 'heading')}}</h3>
            </div>

            <div class="section-header-right">
                <p class="title-description">{{getArrayValue(@$about_content->section_value, 'description')}}</p>
            </div>
        </div>
    </div>
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="grow-left mt-5">
                        <div class="row g-4">
                         ...
                         <a target="_blank" href="{{getArrayValue(@$about_content->section_value, 'btn_url')}}" class="ig-btn btn--lg btn--primary">{{getArrayValue(@$about_content->section_value, 'btn_name')}}</a>
                    </div>
                </div>
            </div>
        </div>
